...
export declare class Datagrid implements AfterContentInit, AfterViewInit, OnDestroy {
    ...
    expandableRows: GlobalExpandableRows;
    constructor(selection: Selection, sort: Sort, filters: FiltersProvider, page: Page, items: Items, rowActionService: RowActionService, expandableRows: GlobalExpandableRows);
     ...
     */
    details: QueryList<DatagridIfExpanded>;
